...
function App() {
  return (
    <div className="min-h-screen bg-slate-50 pb-12 text-slate-800">
      <header className="sticky top-0 bg-white md:px-8">
				<div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-4 md:flex-row md:items-center">
					...
					<nav className="flex flex-wrap gap-5 md:gap-4">
						<a className="py-2 transition-colors" href="home"> Home </a>
						<a className="py-2 transition-colors" href="about"> About</a>
						<a className="py-2 transition-colors" href="services"> Services</a>
						<a className="py-2 transition-colors" href="contact"> Contact</a>
					</nav>
				</div>
			</header>
      
			{/* Home Section */}
      <div className="mx-4 my-6 max-w-5xl border border-slate-200 p-8 shadow-sm md:mx-auto">
				<img className="w-full rounded-xl bg-greenCore-50 md:h-[200px]" src={homeImage} alt="Modern website workspace" />
    	...
    	<div className="mx-4 my-6 max-w-5xl rounded-2xl border border-slate-200 bg-white p-8 shadow-sm md:mx-auto">
			...
			{/* Contact Section */}
      <div className="grid max-w-5xl gap-3 rounded-2xl border border-slate-200 bg-white p-8 shadow-sm md:mx-auto">
          ...
          <h2 className="mb-1 text-2xl font-ManulifeBold text-slate-800"> Contact Us</h2>
          <label className="mt-1 text-slate-700"> Name:</label>
          <input className="w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-slate-800 outline-none transition focus:ring-greenCore-100" type="text" id="name"/>

          <label className="mt-1 text-slate-700"> Email:</label>
          <input className="w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-slate-800 outline-none transition focus:ring-greenCore-100" type="email" id="email"/>
      ...
      <footer className="px-8 pt-6 text-center text-slate-500">
				...
				<a className="mx-2 font-ManulifeDemiBold text-green-700 no-underline"> Privacy Policy</a>
				<a className="mx-2 font-ManulifeDemiBold text-green-700 no-underline"> Terms of Service</a>
      </footer>
    </div>
  )
}
