...
const Contact = () => {
    return (
        <div className="mx-4 my-6 grid max-w-5xl gap-3 rounded-2xl border border-slate-200 bg-white p-8 shadow-sm md:mx-auto">
            ...
            <label className="mt-1 font-ManulifeDemiBold text-slate-700"> Name:</label>
            ...
            <label className="mt-1 font-ManulifeDemiBold text-slate-700"> Email:</label>
            ...
            <label className="mt-1 font-ManulifeDemiBold text-slate-700"> Message:</label>
		    ...
		    <button className="mt-2 w-full rounded-xl bg-greenCore-500 px-5 py-3 font-ManulifeDemiBold text-white transition hover:-translate-y-px hover:bg-greenCore-600 sm:w-fit" type="submit"> Send Message</button>
    	</div>
    )
}
